...
trait FunSets extends FunSetsInterface:
   ...
   */
  def singletonSet(elem: Int): FunSet = i => i == elem //Set(elem)
...
/*
  def union1(s: FunSet, t: FunSet): FunSet =
    def unionThat(i: Int): Boolean =
      s(i) || t(i)
    unionThat
*/
   ...
   */
  def filter(s: FunSet, p: Int => Boolean): FunSet = intersect(s, p) //i => s(i) && p(i)
